      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 ease-in-out">
            ...
            <h1 className="mt-6 font-display text-3xl font-bold leading-tight sm:text-5xl lg:text-6xl">
            ...
            <p className="mt-6 text-base leading-relaxed text-primary-foreground/80 sm:text-lg">
              Under the direction and flagship of its able founder, Mrs. Ashhwini Singh, Rashwin
          ...
          <div className="relative mt-12 lg:mt-0 animate-in fade-in slide-in-from-right-8 duration-1000 ease-out">
            <div className="absolute inset-0 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl" />
            <div className="relative grid grid-cols-1 sm:grid-cols-2 gap-5 p-7">
              {[
                ...
                <div
                  key={s.v}
                  className="group rounded-2xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:bg-white/10 hover:shadow-lg hover:shadow-accent/10"
                >
                  <s.icon size={26} className="mb-4 text-accent transition-transform duration-300 group-hover:scale-110" />
              ...
              <div className="sm:col-span-2 flex flex-col sm:flex-row items-center justify-center sm:justify-start text-center sm:text-left gap-3 rounded-xl border border-accent/30 bg-accent/10 p-5">
